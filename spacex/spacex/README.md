...
## Preparing your SpaceX Configuration
...
1. This SpaceX API is public, so you won't need authentication specific to it. 
...
The config.yaml configuration for spacex.
```bash
  - configuration:
