...
Power your shipping and logistical data with the FedEx backend.

This schema will include authentication to a FedEx Connector to query instances from a fixed schema.
