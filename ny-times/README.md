...
## Preparing your New York Times API Configuration
...
This demo uses the Movie Reviews API found here, https://developer.nytimes.com/docs/movie-reviews-api/1/overview

1. Create a New York Times Developer Account, https://developer.nytimes.com/get-started.
2. Create a new app in the my apps section and copy the API key, https://developer.nytimes.com/my-apps.
...
The config.yaml configuration for ny-times.
