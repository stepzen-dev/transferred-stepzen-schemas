...
Power your shipping and logistical data with the UPS backend.

This schema will include authentication to a UPS Connector to query instances from a fixed schema.
