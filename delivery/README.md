...
Power your shipping and logistical data with the Delivery backend.

This schema will include authentication to a Delivery Connector to query instances from a fixed schema.

## What comes with the Delivery backend <a name="context"></a>

1. Real-time shipping updates for delivery.
2. Side-by-side tracking from multiple backends.
