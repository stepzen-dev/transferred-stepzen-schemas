...
Power your holiday search functionality with the holiday backend.

This schema will include authentication to a Holiday Connector to query instances from a fixed schema.
